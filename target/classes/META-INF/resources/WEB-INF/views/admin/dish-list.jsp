...
<head>
    ...
    <title>Dashboard - Quản lý Món Ăn</title>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <button class="btn btn-purple px-4 py-2" data-bs-toggle="modal" data-bs-target="#addDishModal">
                ...
                <tbody>
                    <c:forEach items="${dishes}" var="dish">
                        <tr>
                            ...
                            <td>
                                <fmt:formatNumber value="${dish.price}" type="number" groupingUsed="true" maxFractionDigits="0"/> đ
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/delete/${dish.dishId}" class="btn btn-sm btn-light text-danger" title="Xóa">
                ...
                <form action="${pageContext.request.contextPath}/admin/add" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="imageUrl" class="form-control" value="https://via.placeholder.com/150">
                        </div>
                        <div class="mb-3">
                ...
                <div class="modal-content">
                    <form action="${pageContext.request.contextPath}/admin/update/${dish.dishId}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Giá tiền (VNĐ)</label>
                                <input type="number" name="price" class="form-control" value="${dish.price}" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Link Hình Ảnh</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Mô tả</label>
                                <textarea name="description" class="form-control" rows="3"><c:out value="${dish.description}"/></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
