                                ...
                                <tbody>
                                    <c:forEach items="${orders}" var="order">
                                        <tr>
                                            <td>
                                                <code
                                                    style="background-color: #f3f4f6; padding: 4px 8px; border-radius: 4px;">
                                        ${order.orderId}
                                    </code>
                                            </td>
                                                ...
                                                <form
                                                    ...
                                                    <select name="status" class="form-select form-select-sm me-2">
                                                        <c:forEach items="${statuses}" var="statusOpt">
                                                            <option value="${statusOpt}" ${statusOpt==order.status
                                                                ? 'selected' : '' }>
                                                                ${statusOpt}
                                                            </option>
                                                        </c:forEach>
            ...
            <body>
                ...
                <div class="sidebar">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/admin/dishes" class="nav-link"><i
                                    class="fa-solid fa-burger"></i> Món ăn</a>
                        </li>
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/admin/orders" class="nav-link active"><i
                ...
                <div class="main-content">
                    <div class="admin-topbar">
                        <div class="topbar-left">
                            <h3 class="topbar-title">Danh sách Đơn hàng</h3>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between align-items-center mb-4" style="margin-top: 30px;">
                        <h4 style="font-weight: 600; color: #374151; margin: 0;">Quản lý các đơn hàng của khách</h4>
                    </div>
