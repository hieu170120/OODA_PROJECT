    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content border-0 shadow">
            <div class="modal-header bg-light">
                <h5 class="modal-title fw-bold" id="couponModalLabel"><i class="bi bi-ticket-perforated text-primary"></i> Chọn Coupon Phu Hop</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <c:if test="${empty couponOptions}">
                    <div class="alert alert-secondary mb-0">Hien tai chua co coupon kha dung.</div>
                </c:if>
                    ...
                    <div class="border rounded-3 p-3 mb-3">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            ...
                            <c:choose>
                                <c:when test="${opt.eligible}">
                                    <span class="badge bg-success">Phu hop</span>
                                </c:when>
                                <c:otherwise>
                                    <span class="badge bg-secondary">Chua du dieu kien</span>
                                </c:otherwise>
                            </c:choose>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="fw-semibold text-danger">
                                Uoc tinh giam: <fmt:formatNumber value="${opt.estimatedDiscount}" type="number" pattern="###,###"/>đ
                            </div>
                            <button type="button"
                                ...
                                ${opt.eligible ? 'Dung ma nay' : 'Khong the ap dung'}
                            </button>
                        </div>
                    </div>
                </c:forEach>
